            ...
            Cell: props => {
                return (
                    <ul className="table-actions">
                        ...
                        <span><Link to={{ pathname: `/proposal/edit/${props.original.id}`}} className="fa fa-edit" title="" data-original-title="Copy"></Link></span>
                    ...
                    <div className="theme-panel">
                        <div className="prosess-tab">
                            <ul className="nav nav-tabs">
                                ...
                                <li className="nav-item">
                                    <button className="nav-link" onClick={this.followProposal}>Follow Up</button>
                                </li>
                                <li className="nav-item">
